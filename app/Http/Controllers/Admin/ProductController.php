    ...
    public function store(ProductRequest $request)
{
    ...
    if ($request->validated()) {
        ...
        if ($request->hasFile('images')) { // Memeriksa apakah ada file yang diunggah
            $images = $request->file('images');
            (new ImageService())->storeProductImages($images, $product);
        }
...
public function update(ProductRequest $request,Product $product)
{
    ...
    if ($request->validated()) {
        ...
        if ($request->hasFile('images')) { // Memeriksa apakah ada file yang diunggah
            ...
            (new ImageService())->storeProductImages($images, $product, $i);
        }
